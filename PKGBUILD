# Maintainer: Samuelzin1109 <samueljogosbons@gmail.com>
# Submitter and original maintainer: Imperator Storm <ImperatorStorm11@protonmail.com>

pkgname=vmware175x-host-modules-dkms-git
_pkgname=vmware-host-modules
pkgver=17.5.1.d20240112.073033.g2c6d66f
_branch_version=17.5.1
url='https://github.com/Samuelzin-jgs/vmware-host-modules'
pkgrel=1
epoch=3
pkgdesc='VMware Workstation host kernel modules (Linux 7.x compatibility fork)'
...
depends=('dkms')
makedepends=('git')
source=("git+https://github.com/Samuelzin-jgs/${_pkgname}.git#branch=linux-7.1-port"
        dkms-vmmon.conf
        dkms-vmnet.conf)
sha256sums=('SKIP'
